...
1. 数据智能智能报告产品介绍视频上传爱乐学；云原生开发培训课件申请审批；iuap5.0产品著作权三个产品证书已申请成功-艾；
2. 智能分析运行环境优化；龙江交投与江苏天工项目培训及支持；数据资产理论框架学习；工欲善其事必先利其器，做好数据项目交付，还需要完善的理论和高效工具做支持-李；
3. XXXXXXX-；

三、[下周工作计划]下周计划：(未完成工作、计划下周新开始的工作)【每人至少填写一条+加名字】(车)

1. iuap5.0产品著作权申请--应用构建平台艾；
2. 分公司远程支持；主数据培训课件优化；数据资产框架理论学习-李；
3. XXXXXXX-；
...
1. 面向顾问的数据产品培训二期学员证书已登记和发放完毕；应用构建平台产品著作权申请资料补充中，等待提供操作手册-艾；
2. 智能分析运行环境监控，龙江交投智能分析支持，数据资产理论框架学习；遇到不熟悉的问题，应该以平常心对待，试着去分析处理，也许没想像的那么困难-李；
3. 华新丽华YonBuilder培训演示支持，一汽项目问题支持；YonBuilder课程体系建立完成，需要在专属化环境上验证；补充了专属化环境配置等功能，专属化版本和公有云版本差异很大，业务中台新版本也有变化，需要同步更新课程-卢；
4. 神州航天软件人力资源项目现场打单产品演示；中国铁路设计科技平台项目沟通，客户有基本的平台规划，暂时不完整，是iuap的一个很小子集，内部现整理各种需求，包括平台、财务、资产、人力、项目等，按照铁道部的施工习惯，客户内部需要整理各种接口外特性，因此用友要投标的化，需要提供平台产品的接口外特性标准，20日前提交给客户，后期会启动招标，目前参与的包括用友、浪潮、金蝶。后期工作是编写标准并在20日前提交给客户-汪
5. 持续学习微服务springcloud技术栈，代码验证，并且形成文档资料，主要了解微服务解决方案中各个模块的常用组件以及不同组件的横向对比，-常；
6. 用友云官网首页维护更新，学习YonBuilder体系前端开发-孙；
7.完成数字化中台生态章节修改，完成数据中台章节内容修改编撰，完成整书图片整理和章节目录调整，完成案例用户授权沟通事宜。-刘


三、[下周工作计划]下周计划：(未完成工作、计划下周新开始的工作)【每人至少填写一条+加名字】(车)

1. iuap5.0产品著作权申请-应用构建平台-艾；
2. 分公司远程支持；智能分析环境监控优化；数据资产框架理论学习-李；
3. YonBuilder课程体系建立完成专属化环境上验证；培训课程设计【应用划分/案例实现方式等】，筹备近期项目培训-卢；
4. 中国铁路设计公司的接口标准接口完善-汪
5. 微服务技术栈学习、资料整理-常；
6. 学习YonBuilder体系前端并完成相关文档输出-孙；
7.完成书稿提交出版社-刘
...
3. 产品推广技术运营：（品牌推广运营、云平台官网建设、市场推广）
    ...
    1.面向顾问的数据产品培训二期考试成绩汇总；

    2.技术中台5.0.1运维实践视频上传爱乐学；
...
1. 面向顾问的数据产品培训第二期爱乐学线上学习和考试已完成，23人参加学习，7人完成考试，6人通过；技术中台5.0.1运维实践视频已上传爱乐学；国资委培训学员技术中台基础调查进行中-艾；
2. PG数据库环境优化（docker）；福建、黑龙江分公司数据产品远程支持；数据资产理论框架学习；发现问题，分析问题，解决问题，并不断迭代优化，是一个有效的学习过程-李；
3. 完成了国产化专区11家厂商精简版PPT和详细版PPT的修改；登记南方峰会伙伴报名信息；编写生态月报-校企合作部分；数字馆客户接待；2020年云平台客户满意度调研重新推送-兰；
4. 讨论针对销售、售前、实施、开发针对大数据能力提升的培训方案-汪；
5. YonBuilder知识体系建设，案例开发，文档逐步完成。目前核心问题是环境不稳定，现在对接的是开发者大赛的特殊环境，不能保证案例顺利完成；一汽项目开发平台中调度任务问题支持-卢；
6. 湖南分公司ESB问题支持；持续学习微服务springcloud技术栈，代码验证，并且形成文档资料-常；
7. 本周完成业务中台内容事项法会计案例编制，完成数字化中台安全内容章节修改，完成数据中台内容修改和2章节技术中台内容的修改工作。-刘
8. 用友云官网维护更新；YonBuilder知识体系建设，前端案例开发、文档完善-孙；

三、[下周工作计划]下周计划：(未完成工作、计划下周新开始的工作)【每人至少填写一条+加名字】(车)

1. 国资委技术中台培训教务；应用构建平台软著申请-艾；
2. 分公司远程支持；服务器环境优化；数据资产框架学习-李；
3. 发布国产化系列宣传稿-兰；
4. 着手针对大数据的能力提升课件开发，神州软件项目现场打单产品演示-汪；
5. YonBuilder案例开发完成，文档基本完成，初步评审-卢；
6. 微服务技术栈学习、资料整理-常；
7. 数字化中台整体内容修改、审稿工作，完成各章扫尾工作，力争给出版社交稿。-刘
8. YonBuilder案例代码调试-孙；
...
1. 面向顾问的数据产品培训一期工作已基本完成，统计成绩、发布打印邮寄证书、发布宣传海报等，学员学习态度认真，考试总体通过率较高；面向顾问的数据产品培训二期考试题已发布；五院技术中台培训视频已剪辑并上传-艾；
2. 智能分析环境搭建；北京国资委分析报表产品售前支持；分析产品集成环境测试；课件完善需要内容不断拓展创新，通过数据框架学习，将知识赋能做到体系化-李；
3. 数字化中台编写-汪；
4. 原生开发指南交稿，开发者大赛环境打通作为YonBuilder内容验证，YonBuilder课程体系建设-开发指南完成了框架部分，开发案例验证中环境不稳定发现大量问题无法保证进度。-卢
5. 国产化专区首篇报道审核；11家厂商架构图及国产化案例PPT已收齐，正修改中；内部行业公司国产化案例PPT基本收齐；《数字化中台》插图修改；制作顾问认证书；发布年会iuap专场伙伴邀约；周四至周六参加新员工大会，系统学习了企业文化/产品/财务制度等等，认识很多新朋友，收获很多-兰；
6. 持续学习微服务springcloud技术栈，代码验证，并且形成文档资料-常；
7. 用友云官网首页开发更新，生态伙伴页面开发上线，前端培训资料整理-孙；


三、[下周工作计划]下周计划：(未完成工作、计划下周新开始的工作)【每人至少填写一条+加名字】(车)

1. 面向顾问的数据产品培训二期教务-艾；
2. 分公司远程支持；数据资产框架学习-李；
3. 数据挖掘课件编写-汪；
4. YonBuilder课程体系建设，添加内容完成iuap5.0开发指南【原生+MDD】初稿-卢；
5. 最终敲定数字馆国产化专区演示方案；2020年云平台客户满意度调研-兰；
6. 微服务技术栈学习、资料整理-常；
7. 用友云官网维护更新，iuap5.0开发指南初稿（前端相关文档提供）-孙；
