...
3. 威顿智慧硫酸项目机器学习的PPT和物联网相关PPT准备；数据移动高级开发内容课件；数据移动军种内容梳理-汪

三、[下周工作计划]下周计划：(未完成工作、计划下周新开始的工作)【每人至少填写一条+加名字】(车)

1. 顾问学习计划整理；培训考试出题信息统计-艾；
2. 广药集团5.0开发培训-卢；
3. 威顿智慧硫酸项目机器学习的PPT和物联网相关PPT准备；数据移动高级开发内容课件-汪
